...
print("PyVISA must also be installed.")
...
print(f"{resources}")
print("Ignoring non-GPIB devives\n")
...
for name in resources:
    if target_interface in name:
        ...
        try:
            inst = rm.open_resource(name)  # Connect to a GPIB address
